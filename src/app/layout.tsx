...
export const metadata: Metadata = {
  ...
  keywords: ["AI", "assistant", "MindBot", "clone", "Next.js"],
  authors: [{ name: "Your Name" }],
  creator: "Ahmed Helmy",
  publisher: "Ahmed Helmy",
  openGraph: {
    title: "MindBot",
    description: "An advanced GPT built with Next.js and Python, featuring enhanced functionalities and faster response times.",
